                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="nama" id="nama" value="{{ old('nama') }}" required class="w-full rounded-lg border-gray-300 shadow-sm text-sm focus:border-indigo-500 focus:ring-indigo-500 @error('nama') border-red-500 @enderror" placeholder="Contoh: Ahmad Hidayat, S.IP">
                                @error('nama')
                            ...
                            <div>
                                ...
                                <input type="text" name="nip" id="nip" value="{{ old('nip') }}" required class="w-full rounded-lg border-gray-300 shadow-sm text-sm focus:border-indigo-500 focus:ring-indigo-500 @error('nip') border-red-500 @enderror" placeholder="199001012023211001">
                                @error('nip')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="nomor_pppk" id="nomor_pppk" value="{{ old('nomor_pppk') }}" class="w-full rounded-lg border-gray-300 shadow-sm text-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="PPPK-2023-0012">
                                @error('nomor_pppk')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="jabatan" id="jabatan" value="{{ old('jabatan') }}" class="w-full rounded-lg border-gray-300 shadow-sm text-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Arsiparis Ahli Pertama">
                                @error('jabatan')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                <label for="foto" class="block text-xs font-semibold text-gray-700 uppercase tracking-wider mb-1">
                                    Foto Pegawai (Opsional, Maks 2MB)
                                </label>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" value="{{ old('email') }}" required class="w-full rounded-lg border-gray-300 shadow-sm text-sm focus:border-indigo-500 focus:ring-indigo-500 @error('email') border-red-500 @enderror" placeholder="nama@subang.go.id">
                                @error('email')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="password" name="password" id="password" class="w-full rounded-lg border-gray-300 shadow-sm text-sm focus:border-indigo-500 focus:ring-indigo-500 @error('password') border-red-500 @enderror" placeholder="Kosongkan jika gunakan default 'password'">
                                @error('password')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <p class="text-xs text-gray-500 mt-2">
                            * Peran (Role) pengguna otomatis disetel sebagai <strong>PPPK</strong>.
                        </p>
                    </div>
